...
interface ButtonProps extends ComponentPropsWithoutRef<"button"> {
  variant?: "primary" | "primaryLight" | "outlined" | "login" | "icon" | "dropbar" | "custom1";
}
...
function Button({ className, variant = "primary", ...props }: ButtonProps) {
  const variantClasses = {
    ...
    icon: "cursor-pointer rounder-none p-2 gap-4 group-hover:bg-gray-400/20 rounded-lg w-full justify-center group-hover/sidebar:justify-start items-center",

...
const SearchSection = () => {
    return (
        <div className="container flex justify-center items-center flex-col mx-auto p-5 h-[90vh] bg-search-background dark:bg-search-background-dark bg-contain bg-center bg-no-repeat bg-transparent">
            <div className='-mt-[10%] w-full'>
                ...
                <div className="flex gap-5">
                    ...
                    <select name="regiao" className='w-2/3 border-none rounded-lg px-4 bg-white dark:bg-white dark:text-primaryDarker text-primaryDarker' >
                    ...
                    <select name="categoria" className='w-2/6 border-none rounded-lg px-4 bg-white dark:bg-white dark:text-primaryDarker text-primaryDarker'>
